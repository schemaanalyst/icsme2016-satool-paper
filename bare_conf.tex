...
\and
\IEEEauthorblockN{Cody Kinneer and Colton McCurdy and Michael Camara\\ and Gregory M. Kapfhammer}
...
% in the abstract
\begin{abstract}
Data stored in relational databases plays a vital role in many aspects of day to day life.
When this data in incorrect, anything from travel plans to medical care could be compromised.
...
evaluating the quality of test data, and includes documentation to support industrial adoption and
future research. 
\end{abstract}
