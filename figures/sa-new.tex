...
\tikzstyle{box}=[draw, line width=0.7mm, minimum width=10em, minimum height=4.5em]
\tikzstyle{box2}=[draw, line width=0.7mm, minimum width=8em, minimum height=4em]
\tikzstyle{box3}=[draw, line width=0.7mm, minimum width=8em, minimum height=9.5em]
\tikzstyle{box4}=[draw, line width=0.7mm, minimum width=8em, minimum height=14.5em]
...
\begin{tikzpicture}[thick,scale=0.85, every node/.style={scale=0.85}]
    ...
    \node [] at (3.75, 3.5) (t) {\texttt{sqlrepresentation}};
    ...
    \path [draw]  (t2.west) +(-0.3,0) -- +(0.15,0) node [above] {}
        (sa.70);
    \path [draw]  (t.west) +(-0.1,0) -- +(0.1,0) node [above] {}
        (b1.0);
    \path [draw]  (t3.west) +(-0.2,0) -- +(0.1,0) node [above] {}
        (b3.0);
    \path [draw]  (t4.east) +(-0.1,0) -- +(0.2,0) node [above] {}
        (b2.0);
    \path [draw]  (t5cont.east) +(-0.1,0) -- +(0.2,0) node [above] {}
        (b4.0);
