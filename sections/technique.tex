...
\lstinputlisting[basicstyle=\small,language=SQL,upquote=true]{figures/Insert.txt}
...
\textit{SchemaAnalyst} supports generating test data for three DBMSs, including SQLite, PostgreSQL, and HyperSQL.
