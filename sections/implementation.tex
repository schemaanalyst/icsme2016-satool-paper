...
to support multiple DBMSs (SQLite, PostreSQL, and HyperSQL), and allow for the addition of new DBMSs. A
...
\texttt{data} package furnishes the three provided test data generators, as well as various generic datatype
representations for use in test data generation. The \texttt{dbms} package provides support for the three currently
