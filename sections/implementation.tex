...
over 64,000 lines of SQL code and 52,000 lines of Java code, thereby enabling others to try the provided examples of
schema testing, reproduce the results from our prior experiments, and apply \sa~to new schemas.
