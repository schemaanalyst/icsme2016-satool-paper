...
\sa~has been used in experimental studies, facilitating research into search-based software testing
and mutation testing. \sa~has been used to enable empirical studies appearing in five published
works.
