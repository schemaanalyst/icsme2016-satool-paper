...
{\sa} has been used to support research studies involving both search-based software
...
\sa. Since past studies have show the benefits of using the presented tool instead of competing open-source systems ---
and now \sa~is also available as an open-source tool --- this paper argues that it is ready to enhance
practitioners' ability to test database schemas.  In summary, the key contributions of this paper are as follows:
