...
% Important numbers
\newcommand{\numschemas}{9\xspace}
\newcommand{\numprovidedschemas}{95\xspace}
\newcommand{\numtestedschemas}{35\xspace}
\newcommand{\numtables}{215\xspace}
\newcommand{\numcolumns}{1174\xspace}
\newcommand{\numconstraints}{769\xspace}
\newcommand{\numuniquepapers}{6\xspace}
\newcommand{\numcoveragecriteria}{9\xspace}
\newcommand{\nummutationoperators}{14\xspace}
\newcommand{\numdatagenerators}{3\xspace}
\newcommand{\numquestions}{968,277}
...
\newcommand{\TimeConstrainedMutation}{Selective Mutation\xspace}  % for captions and headings
\newcommand{\TCM}{\TimeConstrainedMutation}                              % for captions and headings
\newcommand{\timeconstrainedmutation}{selective mutation analysis\xspace}  % for prose
\newcommand{\tcm}{\timeconstrainedmutation}                              % for captions and headings
\newcommand{\tc}{selective mutation\xspace}                                % for prose
